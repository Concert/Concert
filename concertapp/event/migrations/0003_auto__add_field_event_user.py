...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('event_event', 'user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='events', null=True, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Event.user'
        db.delete_column('event_event', 'user_id')
