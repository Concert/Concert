...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Tag.collection'
        db.add_column('tag_tag', 'collection', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='tags', to=orm['collection.Collection']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Tag.collection'
        db.delete_column('tag_tag', 'collection_id')
