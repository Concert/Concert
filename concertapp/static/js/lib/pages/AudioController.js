...
var AudioController = Backbone.Controller.extend(
{
    ...
    _select_file: function(e, selectedAudioFile) {
        ...
        this._load_waveform_image(selectedAudioFile.get_waveform_src(10), function(me) {
            return function() {
                $(me).trigger('file_waveform_loaded');
            }
        }(this));        
    },
    
    _select_segment: function(e, selectedAudioSegment) {
        var audioFile = selectedAudioSegment.get('audioFile');
        
        this._load_audio_file(audioFile, function(me, selectedAudioSegment) {
            return function() {
                /* Start audio loop */
        ...
        /* Load waveform image */
        this._load_waveform_image(audioFile.get_waveform_src(10),
            function(me) {
                return function() {
                    $(me).trigger('segment_waveform_loaded');
                };
            }(this));        
    },
