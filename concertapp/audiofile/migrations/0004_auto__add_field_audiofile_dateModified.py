...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('audiofile_audiofile', 'dateModified', self.gf('django.db.models.fields.DateField')(auto_now=True, auto_now_add=True, default=datetime.date(2011, 10, 21), blank=True), keep_default=False)
