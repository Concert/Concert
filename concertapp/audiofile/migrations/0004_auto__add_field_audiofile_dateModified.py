...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AudioFile.dateModified'
        db.add_column('audiofile_audiofile', 'dateModified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, default=datetime.date(2011, 10, 21), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AudioFile.dateModified'
        db.delete_column('audiofile_audiofile', 'dateModified')
