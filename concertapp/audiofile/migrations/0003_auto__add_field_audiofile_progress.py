...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AudioFile.progress'
        db.add_column('audiofile_audiofile', 'progress', self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=3, decimal_places=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AudioFile.progress'
        db.delete_column('audiofile_audiofile', 'progress')
    ...
    models = {
        'audiofile.audiofile': {
            ...
            'progress': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '3', 'decimal_places': '2'}),
