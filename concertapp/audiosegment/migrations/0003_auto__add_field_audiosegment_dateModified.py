...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AudioSegment.dateModified'
        db.add_column('audiosegment_audiosegment', 'dateModified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, default=datetime.date(2011, 10, 21), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AudioSegment.dateModified'
        db.delete_column('audiosegment_audiosegment', 'dateModified')


    models = {
        'audiofile.audiofile': {
            'Meta': {'object_name': 'AudioFile'},
            'collection': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'audiofiles'", 'to': "orm['collection.Collection']"}),
            'dateModified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        'audiosegment.audiosegment': {
            ...
            'collection': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'audiosegments'", 'to': "orm['collection.Collection']"}),
