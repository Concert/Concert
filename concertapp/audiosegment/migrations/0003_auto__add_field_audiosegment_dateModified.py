...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('audiosegment_audiosegment', 'dateModified', self.gf('django.db.models.fields.DateField')(auto_now=True, auto_now_add=True, default=datetime.date(2011, 10, 21), blank=True), keep_default=False)
    ...
    models = {
        'audiofile.audiofile': {
            ...
            'dateModified': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
